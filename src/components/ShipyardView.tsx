                ...
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono font-bold text-emerald-400 bg-emerald-950/80 px-2 py-0.5 rounded border border-emerald-800">
                      FIXED: 5 PROTECTORS + 3-VEHICLE CONVOY VS 5 ATTACKERS
                    </span>
                  </div>
                  <p className="text-[11px] text-slate-400 mt-0.5">
                    Both combat teams field 5 members, including the player on their selected side. The front Hummer, unique armored semi-truck, and rear Hummer are three additional mission vehicles.
                  </p>
                </div>
